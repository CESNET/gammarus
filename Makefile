...
install-static-files: sdn-roadm-line sdn-roadm-add-drop sdn-roadm-hires-add-drop sdn-roadm-coherent-a-d sdn-inline sdn-roadm-line-g2 sdn-roadm-add-drop-g2 sdn-roadm-hires-add-drop-g2 sdn-roadm-coherent-a-d sdn-inline-g2
